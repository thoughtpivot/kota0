...
import Kota0GuideDeckDialog from "@/components/kota0/shell/Kota0GuideDeckDialog.vue";
...
<template>
  <header
    class="k0-workspace-header sticky top-0 z-30 flex shrink-0 items-center justify-between gap-3 border-b border-white/5 bg-[#0F1115]/85 px-4 py-2.5 backdrop-blur-xl supports-[backdrop-filter]:bg-[#0F1115]/70 md:px-4"
  >
    <div class="flex min-w-0 items-center gap-2">
      ...
      <div class="flex min-w-0 items-center gap-2 pr-1">
        <img src="/k0-white.svg" alt="Kota0" class="h-6 w-auto shrink-0" />
        <h1
