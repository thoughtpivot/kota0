...
import { fetchKota0SuggestAppName } from "@/components/kota0/apps/kota0AppApi";
import { pickKota0AppNameClientFallback } from "@/components/kota0/apps/kota0AppNameFallback";
...
<template>
  ...
  >
    ...
    <div
      ...
      role="dialog"
      aria-modal="true"
      aria-labelledby="kota0-first-app-title"
    ...
    >
      ...
      <div class="relative mt-6">
        <label class="sr-only" for="kota0-first-app-input">App name</label>
        <input
          id="kota0-first-app-input"
          ref="inputRef"
          type="text"
          autocomplete="off"
          :value="modelValue"
