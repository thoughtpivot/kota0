...
export function usePlanChat() {
  ...
  function seedWelcome() {
    ...
    messages.value.push({
      ...
      role: "assistant",
      content:
        "Welcome to **Kota0 — Prompt**. What do you want to build? Describe the app in a sentence or two — we will iterate here; use **Apply** to push the latest assistant reply into the generated `App.vue` shown in Preview.",
