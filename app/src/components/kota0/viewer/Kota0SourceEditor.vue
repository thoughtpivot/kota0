...
<template>
  <div class="k0-cm-shell h-full min-h-0 w-full overflow-hidden rounded-md border border-input bg-background shadow-sm">
    <Codemirror
      v-model="model"
...
.k0-cm-shell :deep(.cm-scroller) {
  flex: 1 1 0;
  min-height: 0;
  overflow: auto;
}

.k0-cm-shell :deep(.cm-focused) {
  outline: none;
}
</style>
