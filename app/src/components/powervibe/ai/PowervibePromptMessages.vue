...
const c = inject(POWERVIBE_PROMPT_CONTROLLER);
if (!c) throw new Error("PowervibePromptMessages requires POWERVIBE_PROMPT_CONTROLLER");

const ctrl = c as PowervibePromptController;
