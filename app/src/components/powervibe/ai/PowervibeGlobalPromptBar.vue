...
const injected = inject(POWERVIBE_PROMPT_CONTROLLER);
if (!injected) throw new Error("PowervibeGlobalPromptBar requires POWERVIBE_PROMPT_CONTROLLER");

const ctrl = injected as PowervibePromptController;

const composerRef = useTemplateRef<InstanceType<typeof PowervibeChatComposer>>("composerRef");
...
<template>
  <Teleport to="body">
    ...
    >
      ...
      >
        <div
          data-powervibe-global-prompt
          class="powervibe-global-prompt-solid w-full rounded-xl border border-white/10 bg-[#0f1115] text-slate-100 shadow-2xl"
          role="dialog"
          aria-modal="false"
        ...
        >
          ...
          <div class="p-3">
            <PowervibeChatComposer
              ...
              compact
              :show-mic="false"
              input-id="powervibe-global-ai-input"
