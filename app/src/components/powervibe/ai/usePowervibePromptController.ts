...
export type PowervibePromptControllerOptions = {
  activeAppId: MaybeRefOrGetter<string | null>;
  refreshChatKey: MaybeRefOrGetter<number>;
  onApplied: () => void;
};

export function usePowervibePromptController(opts: PowervibePromptControllerOptions) {
...
export type PowervibePromptController = ReturnType<typeof usePowervibePromptController>;

export const POWERVIBE_PROMPT_CONTROLLER: InjectionKey<PowervibePromptController> = Symbol(
  "powervibePromptController",
);
