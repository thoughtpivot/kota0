...
interface ImportMetaEnv {
   ...
   * same-origin `…/__powervibe_slidev/…` (Vite proxies to Slidev so `/…` assets load correctly in the iframe).
  ...
  readonly VITE_POWERVIBE_GUIDE_SLIDEV_PROXY_TARGET_PORT?: string;
}
