...
Official wordmark copied from the public marketing site for internal PoC use only. **Trademark:** ThoughtPivot retains all rights; do not alter geometry or colors inside the SVG except where required for responsive sizing (scale uniformly).

| File | Canonical URL |
| --- | --- |
| `tp.svg` | `https://www.thoughtpivot.com/tp.svg` |
