/**
 * PowerVibe default bundle: one-line multilingual “greeting, smart name” for demo UI.
 ...
 */
export async function generatePowervibeDemoGreetingPhrase(): Promise<{ phrase: string; source: "ai" | "fallback" }> {
  try {
    const text = await powervibePlatformAiCompleteText({
      prompt:
