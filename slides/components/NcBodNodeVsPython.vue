<template>
  <div class="nc-kota0-nodecred">
    ...
    <ul class="nc-kota0-nodecred__list">
      ...
      <li>
        <strong>Integrated delivery</strong> — patterns hardened across years of enterprise web platforms (tooling, APIs, governance),
        not a first-time experiment on disposable demos.
      </li>
      <li>
        <strong>Ownership</strong> — aligns with Git-based review and customer-controlled hosting already described on the
        product slide.
      </li>
    </ul>
  </div>
